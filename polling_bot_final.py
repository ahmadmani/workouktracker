...
def process_update(update):
    ...
    if "message" in update:
        ...
        if text == "/start":send_message(chat_id, "💥 <b>Welcome to Ahmad's Workout Bot!</b> 💥\n\n"
                                  "Track your daily exercises, mark them as done ✅, and stay fit! 💪\n"
                                  "Choose a category below to begin 👇", get_main_menu())
        ...
        if data == "reset":
            ...
            save_progress()
            send_message(chat_id, "🔄 Progress has been reset.", get_main_menu())
            ...
            send_message(chat_id, "🏋️ Choose a category:", get_main_menu())
            ...
            save_progress()
            send_message(chat_id, f"📂 <b>{category}</b> exercises updated:", get_exercise_menu(user_id, category))
